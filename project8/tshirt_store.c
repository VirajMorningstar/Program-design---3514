...
======================================================================
*Description: 
The program manage the database of a T-shirt store. The programe allove the user to add itemes to the inventory and seach for items of the inventory. 
